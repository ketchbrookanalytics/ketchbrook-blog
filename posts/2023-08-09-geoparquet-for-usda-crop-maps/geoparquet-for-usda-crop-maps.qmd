...
Perhaps you know that the [{ggplot2} library](https://ggplot2.tidyverse.org/) is great for developing static charts, but did you know it can produce beautiful maps, too? Here's a chart showing the crop type in each individual geometry (i.e., crop service boundary) in Hartford County, Connecticut.
