...
Now let's summarize the top five crops for the last four years in the data set. The [ggcharts](https://github.com/thomas-neitmann/ggcharts) package provides nice shortcuts to making faceted bar charts that we might as well use.
...
So now that you now this data exists and have a starting point for analyzing it, where can you go from here?
