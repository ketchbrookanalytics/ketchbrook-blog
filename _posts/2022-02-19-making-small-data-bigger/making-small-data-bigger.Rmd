...
description: |
  Don't limit your data by your choice of model.
...
One of the caveats of working with your traditional vanilla machine learning algorithms (e.g., linear regression, logistic regression, decision trees, etc.) is that each case (row) in your training data set *must be independent*. Let's explore what exactly this means.
...
This type of data is sometimes referred to as *"longitudinal"* data, and represents observations of the same subject(s) over multiple points in time. In our case, the *"subjects"* are the unique loans.

### What's to be Gained

* more data
* less class imbalance
* more insight into loan history (e.g., want to distinguish between a loan that defaulted after being on the books for 3 years vs 3 months)
